...
public class AppManagerActivity extends AppCompatActivity implements ActionBar.TabListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.title_activity_app_manager).toUpperCase(l);
                case 1:
                    return getString(R.string.title_activity_memory_manager).toUpperCase(l);
                case 2:
                    return getString(R.string.title_activity_phone_info).toUpperCase(l);
            }
            return null;
        }
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_app_manager, container, false);
            return rootView;
        }
    }
