...
//	private ImageView mFooterImageView;
     ...
     * 上拉加载文字提示
     */
    private String footer_release_label,footer_refresh_label,footer_refreshing_label;
    ...
    public void setFooterRefreshString(String footer_release_label,String footer_refresh_label,String footer_refreshing_label){
        this.footer_release_label = footer_release_label;
        this.footer_refresh_label = footer_refresh_label;
        this.footer_refreshing_label = footer_refreshing_label;
    }

    public void setDefRefreshString(){
        footer_release_label = getContext().getString(R.string.pull_to_refresh_footer_release_label);
        footer_refresh_label = getContext().getString(R.string.pull_to_refresh_footer_pull_label);
        footer_refreshing_label = getContext().getString(R.string.pull_to_refresh_footer_refreshing_label);
    }
...
//			mFooterView.setVisibility(View.VISIBLE);
                int deltaY = y - mLastMotionY;
                if (mPullState == PULL_DOWN_STATE && enablePullTorefresh) {
                    // PullToRefreshView执行下拉
                    Log.i(TAG, " pull down!parent view move!");
                    headerPrepareToRefresh(deltaY);
                    // setHeaderPadding(-mHeaderViewHeight);
                } else if (mPullState == PULL_UP_STATE
                        && enablePullLoadMoreDataStatus) {
...
//			mFooterImageView.clearAnimation();
//			mFooterImageView.startAnimation(mFlipAnimation);
            mFooterTextView.setText(footer_refresh_label);
...
//		mFooterImageView.setImageDrawable(null);
        ...
        mFooterTextView
                .setText(footer_refreshing_label);
