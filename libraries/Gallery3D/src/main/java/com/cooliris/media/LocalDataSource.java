...
public class LocalDataSource implements DataSource {
    ...
    public static final String URI_ALL_MEDIA = Images.Media.EXTERNAL_CONTENT_URI.toString();
    ...
    public LocalDataSource(final Context context, final String uri, final boolean flattenAllItems) {
        ...
        if (mBucketId == null) {
            if (uri.equals(Images.Media.EXTERNAL_CONTENT_URI.toString())) {
                mAllItems = true;
            } else {
                mAllItems = false;
            }
        ...
        mDone = false;
        mDiskCache = mUri.startsWith(Images.Media.EXTERNAL_CONTENT_URI.toString())
                || mUri.startsWith(Video.Media.EXTERNAL_CONTENT_URI.toString())
    ...
    private static boolean isSingleImageMode(String uriString) {
        return !uriString.equals(Images.Media.EXTERNAL_CONTENT_URI.toString())
                && !uriString.equals(Images.Media.INTERNAL_CONTENT_URI.toString());
    }
    ...
    public void loadItemsForSet(MediaFeed feed, MediaSet parentSet, int rangeStart, int rangeEnd) {
        ...
        if (mSingleUri && !mDone) {
            ...
            if (mUri.startsWith(Images.Media.EXTERNAL_CONTENT_URI.toString())
                || mUri.startsWith(Video.Media.EXTERNAL_CONTENT_URI.toString())) {
            ...
            parentSet.generateTitle(true);
        } else if (mUri.equals(Images.Media.EXTERNAL_CONTENT_URI.toString()) & mFlattenAllItems) {
    ...
    private static boolean isImage(String uriString) {
        return !uriString.startsWith(Video.Media.EXTERNAL_CONTENT_URI.toString());
    }
    ...
    public void loadMediaSets(final MediaFeed feed) {
        ...
        if (mSingleUri) {
            ...
            if (mFlattenAllItems) {
                ...
                set.mId = getBucketId(Images.Media.EXTERNAL_CONTENT_URI.toString() + "/" + set.mName);
