 ...
 * operations.
 *
 * <p>The function {@link #decodeFileDescriptor(java.io.FileDescriptor,
 * android.graphics.BitmapFactory.Options)} is used to decode a bitmap. During decoding another
 * thread can cancel it using the function {@link #cancelThreadDecoding(Thread,
 * android.content.ContentResolver)} specifying the {@code Thread} which is in decoding.
 *
