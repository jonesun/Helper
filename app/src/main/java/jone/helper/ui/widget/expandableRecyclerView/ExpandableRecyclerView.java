package jone.helper.ui.widget.expandableRecyclerView;
 ...
 * <p>You must use an {@link jone.helper.ui.widget.expandableRecyclerView.ExpandableRecyclerView.ExpandableAdapter} instead of a {@link android.support.v7.widget.RecyclerView.Adapter}
 * and an {@link jone.helper.ui.widget.expandableRecyclerView.ExpandableRecyclerView.ExpandableViewHolder} instead of a {@link android.support.v7.widget.RecyclerView.ViewHolder}.</p>
...
public class ExpandableRecyclerView extends RecyclerViewWithHeader {
    ...
    public static abstract class ExpandableAdapter<VH extends ExpandableViewHolder, T> extends Adapter<VH> implements ExpandHandler {
         ...
         * This is the mode to handle the stable ID used to recover the position. It replaces {@link jone.helper.ui.widget.expandableRecyclerView.ExpandableRecyclerView.ExpandableAdapter#hasStableIds()}
    ...
    /**
     * Use {@link #setExpandableAdapter(jone.helper.ui.widget.expandableRecyclerView.ExpandableRecyclerView.ExpandableAdapter)}.
     */
    @Deprecated
    @Override
